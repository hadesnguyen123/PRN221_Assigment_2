    ...
    public static class DbInitializer
    {
        ...
        public static void Initialize(AppDbContext context)
        {
            ...
            if (!context.Accounts.Any())
            {
                ...
                {
                    new Account { FullName = "Nguyễn Hoàng", Password = "123456", Username = "nguyenhoang", Type = AccountType.Staff},
                    new Account { FullName = "Hades Nguyễn", Password = "123456", Username = "hadesnguyen", Type = AccountType.Normal}
                };
